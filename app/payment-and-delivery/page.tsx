            ...
            <main className="max-w-4xl mx-auto px-6 sm:px-8 py-16 sm:py-20">
                ...
                <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed text-justify space-y-8 border-t border-gray-100 pt-10">
                    ...
                    <div className="p-4 bg-stone-50 border-l-4 border-stone-500 text-stone-900 text-sm font-medium rounded-r">
                        🔞 Згідно із законодавством України, ми не здійснюємо продаж алкогольних напоїв особам, які не досягли 18 років. Оформлюючи замовлення на сайті, ви підтверджуєте своє повноліття.
                    </div>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            2.2. Для зручності покупців доступні два способи розрахунку:
                        </p>
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li>
                                <strong>Післяплата (накладений платіж):</strong> Оплата готівкою або банківською карткою безпосередньо в момент отримання замовлення у відділенні компанії-перевізника. Зверніть увагу, що оператор поштового зв&apos;язку стягує додаткову комісію за послугу переказу коштів згідно зі своїми тарифами.
                            </li>
                        </ul>
                        <p>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            4.3. У разі виявлення пошкодження тари чи розливу продукції під час транспортування, покупець має скласти Акт про пошкодження вантажу разом із представником &quot;Нової Пошти&quot;, відмовитися від отримання посилки та повідомити про це нашу службу підтримки для оперативного надсилання заміни.
                        </p>
                    </section>
