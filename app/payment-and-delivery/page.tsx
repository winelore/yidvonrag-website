            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-56 sm:pt-48 md:pt-40 pb-16 sm:pb-20">
                ...
                <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed text-justify space-y-8 border-t border-gray-100 pt-10">
                    ...
                    <div className="p-4 bg-stone-50 border-l-4 border-stone-500 text-stone-900 text-sm font-medium rounded-r">
                        🔞 Згідно із законодавством України, ми не здійснюємо продаж алкогольних напоїв особам, які не досягли 18 років. Під час оформлення замовлення Покупець зобов&apos;язаний підтвердити, що йому виповнилося 18 років та він має законне право придбавати алкогольну продукцію.
                    </div>
