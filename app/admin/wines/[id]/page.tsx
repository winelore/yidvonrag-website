    ...
    return (
        <div className="p-8 pb-20 sm:p-20 font-[family-name:var(--font-geist-sans)] max-w-3xl mx-auto">
            <Link href="/admin/wines"
                  className="text-sm text-foreground hover:underline inline-flex items-center gap-2 mb-6">
                &larr; Назад до списку
            </Link>

            <div
                className="rounded-2xl border border-black/[.08] dark:border-white/[.145] bg-white dark:bg-black p-8 shadow-sm">
                ...
                <AdminForm id="update-wine-form" action={updateWineWithId} className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        ...
                        <div className="flex flex-col gap-1.5 flex-1">
                            <label htmlFor="sweetness"
                                   className="text-sm font-medium text-foreground">Солодкість</label>
                            <input
                                type="text"
                                id="sweetness"
                                name="sweetness"
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        <div className="flex flex-col gap-1.5 flex-1">
                            <label htmlFor="volume"
                                   className="text-sm font-medium text-foreground">{"Об'єм (л)"}</label>
                            <input
                                type="number"
                                step="0.01"
                                id="volume"
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        <div className="flex flex-col gap-1.5 flex-1">
                            <label htmlFor="grapeVariety" className="text-sm font-medium text-foreground">Сорт
                                винограду</label>
                            <input
                                type="text"
                                id="grapeVariety"
                    ...
                    <div className="flex items-center gap-3 mt-2">
                        ...
                        />
                        <label htmlFor="inStock" className="text-sm font-medium text-foreground cursor-pointer">В
                            наявності</label>
                    </div>
