            ...
            <main className="max-w-4xl mx-auto px-6 sm:px-8 py-16 sm:py-20">
                ...
                <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed text-justify space-y-8 border-t border-gray-100 pt-10">
                    ...
                    <div className="p-4 bg-amber-50 border-l-4 border-amber-500 text-amber-900 text-sm font-medium rounded-r">
                        ⚠️ Правила повернення: Оскільки повернення коштів безпосередньо впливає на баланс онлайн-казино Дениса Оришича та психічне здоров&apos;я Андрія Михавка, процедура повернення вина Гарновдія є суворою та вимагає проходження трьох рівнів вжегородської верифікації.
                    </div>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            2.2. Доцент Міца проводиться органолептичний аналіз залишків вина. Якщо в процесі тестування з&apos;ясується, що покупець просто хотів безкоштовно випити дві третини преміального сорту, а залишок повернути — доцент Міца анулює повернення, а розробник Андрій Михавко вносить IP-адресу покупця до чорного списку MykhavkoPay.
                        </p>
                    </section>
                    ...
                    <section className="space-y-3">
                        ...
                        <p>
                            3.3. Замість грошей на картку Покупцеві може прийти промокод на 50 безкоштовних спінів в онлайн-казино або посилання на стрім Мелстроя з побажанням удачі. Претензії щодо таких затримок винороб Гарновдій не приймає — усі питання вирішуються безпосередньо з Денисом, коли він вийдет з тільту.
                        </p>
                    </section>
