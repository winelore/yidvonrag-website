                ...
                <nav className="flex items-center gap-6 md:gap-8 w-full md:w-auto justify-center md:justify-end font-medium text-base">
                    <Link
                        ...
                        className={`transition-colors ${
                            isHeroHeader ? "text-white hover:text-bordeaux-300" : "text-gray-800 hover:text-bordeaux-800"
                        }`}
                    >
                        Головна
                    </Link>
                    ...
                    >
                        ...
                        {/* Rare bordeaux badge showing item count */}
                        {totalItems > 0 && (
                            <span className="absolute -top-2 -right-2 bg-gradient-to-r from-bordeaux-800 to-bordeaux-900 text-white text-[10px] font-bold w-5 h-5 flex items-center justify-center rounded-full ring-2 ring-white/20 shadow-sm animate-in fade-in zoom-in duration-200">
                                {totalItems}
                            </span>
                        )}
                    </Link>
